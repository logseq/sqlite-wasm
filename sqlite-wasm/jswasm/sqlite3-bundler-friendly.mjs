    ...
    Module.postRun.push(function (Module) {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
        ...
        class OpfsSAHPool {
          ...
          importDb(name, bytes) {
            if (bytes instanceof ArrayBuffer) bytes = new Uint8Array(bytes);else if (bytes instanceof Function) return this.importDbChunked(name, bytes);
            const sah = _classPrivateFieldGet(this, _mapFilenameToSAH).get(name) || this.nextAvailableSAH() || toss('No available handles to import to.');
            const n = bytes.byteLength;
            if (n < 512 || n % 512 != 0) {
        ...
        class OpfsSAHPoolUtil {
          ...
          async acquireAccessHandles() {
            return _classPrivateFieldGet(this, _p).acquireAccessHandles(false);
          }
          async removeVfs() {
